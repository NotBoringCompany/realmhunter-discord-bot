    ...
    .setFields(
        {
            ...
            Or, if you're not whitelisted but you're a Server Booster, you can collect **${process.env.MORE_CLAIMABLE_TAGS}** cookies daily. \n\
        ...
        },
        {
            ...
            Once this trial ends, you won\'t be able to earn any more cookies. \n\
            You will be able to use these cookies for the second trial of the Genesis Trials.',
        },
        {
